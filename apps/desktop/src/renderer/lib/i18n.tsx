...
const en = {
  "app.notification": "DSCode notification",
  ...
  "composer.caption": "DSCode can make mistakes. Review changes before committing.",
  ...
  "composer.prompt": "Ask DSCode to build, fix, or explain…",
  "composer.previewImage": "Preview image",
  "composer.removeImage": "Remove image",
  "composer.runningPrompt": "Add instructions while DSCode works…",
  ...
  "preview.restartRequired": "File preview was updated. Quit and reopen DSCode to load it.",
  ...
  "settings.aboutTagline": "A coding agent powered by DeepSeek.",
  "settings.agent": "Agent",
  "settings.agentDescription": "Choose how DSCode can work inside your local projects.",
  "settings.agentTitle": "Agent defaults",
  "settings.appearance": "Appearance",
  "settings.appearanceDescription": "Preview and choose how DSCode looks.",
  ...
  "settings.dark": "Dark",
  "settings.darkThemeDescription": "Always use DSCode's dark appearance",
  ...
  "settings.generalDescription": "Manage your local profile and the language DSCode uses across the app.",
  ...
  "settings.lightThemeDescription": "Always use DSCode's light appearance",
  ...
  "settings.permissionDescription": "Applies to this conversation only and is remembered when you reopen it.",
  ...
  "settings.themeUnavailable": "The selected custom theme is no longer available. DSCode now follows the system appearance.",
...
const zhCN: Record<TranslationKey, string> = {
  ...
  "composer.caption": "DSCode 可能会出错，提交前请检查改动。",
  ...
  "composer.prompt": "让 DSCode 构建、修复或解释…",
  "composer.previewImage": "查看大图",
  "composer.removeImage": "移除图片",
  "composer.runningPrompt": "在 DSCode 工作时补充说明…",
  ...
  "preview.restartRequired": "文件预览组件已更新，请完全退出并重新打开 DSCode。",
  "preview.title": "预览",
  ...
  "settings.about": "关于",
  "settings.aboutTagline": "由 DeepSeek 驱动的编码智能体。",
  "settings.agent": "智能体",
  "settings.agentDescription": "选择 DSCode 在本地项目中的工作方式。",
  "settings.agentTitle": "智能体默认设置",
  "settings.appearance": "外观",
  "settings.appearanceDescription": "预览并选择 DSCode 的界面外观。",
  ...
  "settings.light": "浅色",
  "settings.lightThemeDescription": "始终使用 DSCode 浅色外观",
  "settings.models": "模型",
  ...
  "settings.permissionDescription": "仅应用于当前会话，切换会话或重新打开后仍会保留。",
  ...
  "settings.themeUnavailable": "所选自定义主题已不可用，DSCode 已恢复为跟随系统外观。",
...
export function I18nProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    let cancelled = false;
    void window.dscode.settings.getLanguage()
      .then((savedLanguage) => {
  ...
  const setLanguage = useCallback(async (next: LanguagePreference) => {
    ...
    try {
      await window.dscode.settings.setLanguage(next);
    } catch (error) {

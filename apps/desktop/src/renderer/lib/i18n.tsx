...
const en = {
  ...
  "conversation.editMessage": "Edit and resend",
  "conversation.messageCopied": "Copied",
  "context.cache": "Cache",
  ...
  "sidebar.confirmDeleteSession": "Delete \"{title}\" permanently?",
  ...
  "status.cannotDeleteWhileRunning": "Stop the current response before deleting this conversation.",
...
const zhCN: Record<TranslationKey, string> = {
  ...
  "conversation.editMessage": "编辑并重新发送",
  "conversation.messageCopied": "已复制",
  "context.cache": "缓存率",
  ...
  "sidebar.commands": "命令",
  "sidebar.confirmDeleteSession": "确定要永久删除“{title}”吗？",
  ...
  "status.cannotDeleteWhileRunning": "当前回复进行中，请停止后再删除对话。",
